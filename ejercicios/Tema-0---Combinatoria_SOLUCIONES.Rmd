...
La forma de acabar la carera con variaciones con repetición $$VR_{n=10}^k=4=\frac{10!}{(10-4)!}=10\cdot 9\cdot 8\cdot 7=`r 10*9*8*7`.$$
...
PRIMERA: Si contamos sólo las  cómo sacamos las 10 bombillas son ${10 \choose 3}= \frac{10!}{3!\cdot (10-3)!}=`r choose(10,3)`.$

SEGUNDA: Contamos  las distintas maneras de  obtener las distintas  configuraciones de 25, 40 y 100 vatios.
...
Pues son $VR_{n=9}^{k=3}\cdot VR_{n=24}^{k=3}=9^3\cdot 24^3=`r 9^3*24^3`.$ 
...
Pues de 1 manera..... si lo que queremos es todos los posibles encuentros ${8\choose 2}=`r choose(8,2)`$.
