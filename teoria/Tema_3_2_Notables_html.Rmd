...
```{r uniforme_plots1_interactivo, echo = FALSE,eval=FALSE,eval=FALSE}
fluidPage(
fluidRow(
  column(4,
...
```{r cuantiles_graficosPOBIN, echo = FALSE,eval=FALSE}
fluidPage(
fluidRow(
  column(3,
...
```{r uniforme_plots1_interactivo_exponencial, echo = FALSE,eval=FALSE}
fluidPage(
fluidRow(
  column(4,
...
```{r NORMAL_plots1_interactivo, echo = FALSE,eval=FALSE}
fluidPage(
fluidRow(
  column(3,
