...
si el peluquero lleva ya esperando más de $s>0.25$  un cuarto de hora  la probabilidad de que espere $t=0.6$ de hora más (10 minutos) no cambia sigue siendo 
...
$$
Var(X)=\frac{1}{\lambda^2}=\frac{1}{4^2}=0.625.
$$
...
$$
P(X>0.5)=1-P(X\leq 0.5)=1-(1-e^{-3\cdot 0.5 })=e^{-1,5})=0.2231302.
$$
</div>
