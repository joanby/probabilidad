...
\end{pmatrix}$
la matriz de covarianzas del vector aleatorio $n$ dimensional $\underline{X}=\begin{pmatrix} X_1\\ X_2\\ \vdots \\ X_p\end{pmatrix}$.
...
Efectivamente recordemos que la varianza de una suma (que siempre es positiva ) es  igual  una suma ponderada de todas las covarianzas, efectivamente 
